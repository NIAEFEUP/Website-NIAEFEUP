...
exports.approve = function(req, res) {
  ...
  Candidatura.model.find({"_id":req.body['accept']}, 'name email').exec(function(err, results){

    for (var i = 0; i < results.length; i++) {
      var url = 'https://slack.com/api/users.admin.invite?token=' + process.env.SLACK_INVITE  + '&email=up201405323@fe.up.pt'; // mudar para o email da pessoa
